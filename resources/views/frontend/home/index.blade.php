    	...
    	<div class="container container-fluid" style="width: 100vw;">
            ...
            <div class="row">
                ...
                <div class="home-nav animated fadeInDown col-lg-12 no-padding-margin">
                    <a class="col-lg-2 col-md-2 col-sm-4 col-xs-6 no-padding-margin flex-r align-v justify-c big-john experimenteerbuurt" href="/wat-is-de-experimenteerbuurt">Experimenteer buurt?</a>
