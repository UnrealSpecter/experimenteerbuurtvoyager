...
<div class="sponsors col-lg-12 flex-r align-v">
    <a class="col-lg-3 col-md-3 col-sm-3 col-xs-6 sponsor d-none flex-r align-v" target="_blank">
        <img class="img-fluid" src=" {{ URL::asset('/images/about-us/experimenteerbuurt-logo-2.png') }} ">
    </a>
    <a class="col-lg-3 col-md-3 col-sm-3 col-xs-6 sponsor d-none flex-r align-v" target="_blank" href="https://gemeente.emmen.nl/">
        <img class="img-fluid" src=" {{ URL::asset('/images/about-us/gemeente-emmen.png') }} ">
    </a>
    <a class="col-lg-3 col-md-3 col-sm-3 col-xs-6 sponsor d-none flex-r align-v" target="_blank" href="https://www.domesta.nl/Home.html">
        <img class="img-fluid" src=" {{ URL::asset('/images/about-us/domesta.png') }} ">
    </a>
    <a class="col-lg-3 col-md-3 col-sm-3 col-xs-6 sponsor d-none flex-r align-v" target="_blank" href="http://www.koenenbouwemmen.nl/">
