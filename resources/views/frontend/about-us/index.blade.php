...
@section('content')
    ...
    <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 about-us-wrapper" style="background: transparent; height: 100vh; z-index: 10;">
        <div class="row animated slideInRight" style="height: 100%;">
            ...
            <div class="col-12 d-xs-block d-sm-block d-md-block d-lg-none d-xl-none button-container flex-r no-padding-margin">
                <!-- button left -->
                <div class="col-2 d-lg-none d-xl-none no-padding-margin d-flex align-v justify-c no-drag">
                    <img class="img-fluid prev-arrow" src="{{ asset('images/icons/chevron-left.svg') }}">
                </div>
                <div class="col-8 no-padding-margin contact-text-wrapper d-flex flex-r" style="height: 100%;">
                    <!-- cycle buttons -->
