...
;( function( window ) {
	...
	FForm.prototype._addControls = function() {
		...
		this.ctrlContinue = createElement( 'button', { cName : 'fs-continue', inner : 'Verder', appendTo : this.ctrls } );
		...
		var self = this,
			onEndAnimationFn = function( ev ) {
				...
				if( self.isLastStep ) {
					...
					$('.doener-form').css('overflow-x', 'scroll');
	...
	FForm.prototype._showError = function( err ) {
		...
		switch( err ) {
			case 'NOVAL' :
				message = 'Dit veld moet ingevuld worden voordat je door kan gaan';
				break;
			case 'INVALIDEMAIL' :
				message = 'Vul een correct email formaat in';
				break;
			// ...
		};
